  ...
  return (
    <div className="flex flex-col w-full bg-white -mt-[100px]">
      ...
      <section className="relative py-28 lg:py-36 bg-[#FAFAF8] overflow-hidden flex items-center justify-center min-h-[550px]">
        ...
        {/* Left Subject Image */}
        <div className="absolute left-0 bottom-0 top-0 w-[45%] md:w-[35%] lg:w-[25%] pointer-events-none z-0 opacity-100 sm:opacity-60 transition-opacity duration-700 hover:opacity-80">
          <Image
            src="/model-left.png"
        ...
        {/* Right Subject Image */}
        <div className="absolute right-0 bottom-0 top-0 w-[45%] md:w-[35%] lg:w-[25%] pointer-events-none z-0 opacity-100 sm:opacity-60 transition-opacity duration-700 hover:opacity-80">
          <Image
            src="/model-right.png"
