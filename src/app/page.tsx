  ...
  return (
    <div className="flex flex-col w-full bg-white -mt-[100px]">
            ...
            <ScrollReveal className="relative">
              ...
              <div className="group order-2 md:order-1 relative h-[600px] w-[85%] mx-auto overflow-hidden rounded-[150px] md:rounded-[250px] transition-transform duration-[1500ms] hover:scale-[1.02]">
                <div className="relative h-full w-full overflow-hidden">
                  <Image src="/store.jpg" alt="Whyy Shop HOK" fill className="object-cover transition-transform duration-[2000ms] group-hover:scale-110 grayscale-[10%]" sizes="(max-width: 768px) 100vw, 50vw" />
                </div>
              </div>
            </ScrollReveal>
      ...
      <section className="relative py-28 lg:py-36 bg-[#FAFAF8] overflow-hidden flex items-center justify-center min-h-[550px]">
        ...
        {/* Right Subject Image */}
        <div className="absolute right-0 bottom-0 top-0 w-[45%] md:w-[35%] lg:w-[25%] pointer-events-none z-0 opacity-100 sm:opacity-100 transition-opacity duration-700">
          <Image
            src="/model-right.png"
